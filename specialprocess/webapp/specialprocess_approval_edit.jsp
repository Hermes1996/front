...
<div class="page-container">
    <div class="page-content">
        <div class="row" id="fee-list">
            <div class="col-md-12">
                <form class="form-horizontal" role="form" id="submit-form" action="${CONTEXT_PATH}special/process/approval/update" role="form" method="post">
                    <table class="table table-bordered table-condensed">
                        <input type="hidden" name="specialProcess.id" value="${domain.specialProcess.id}">
                        ...
                        <tr>
                            ...
                            <td><app:input name="specialProcess.sku" classes="input-large" placeholder="请输入一个SKU" required="true" maxLength="32" /></td>
                        </tr>
                        <tr>
